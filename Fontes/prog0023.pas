...
var
  FormCadVeiculos: TFormCadVeiculos;
...
procedure TFormCadVeiculos.brnExcluirClick(Sender: TObject);
begin
...
procedure TFormCadVeiculos.btnFecharClick(Sender: TObject);
begin
  close;
end;

procedure TFormCadVeiculos.btnGravarClick(Sender: TObject);
var
  v_status : boolean;
begin
...
procedure TFormCadVeiculos.edCodiExit(Sender: TObject);
begin
...
procedure TFormCadVeiculos.edCodiPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  edcodi.Text:= consulta('cons_veiculo');
  edCodiExit(self);
  eddesc.SetFocus;
end;

procedure TFormCadVeiculos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action:= cafree;
  FormCadVeiculos:= nil;
end;

procedure TFormCadVeiculos.FormShow(Sender: TObject);
begin
  // carrega os dados do form
  lbTitu.Caption               := 'Veiculos';
  Caption                      := '..::PROG0023::..';
  v_tabela                     := 'veic';
  v_esquema                    := 'cadastro';
...
procedure TFormCadVeiculos.quTableAfterCancel(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Navegando...';
end;

procedure TFormCadVeiculos.quTableAfterPost(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Navegando...';
end;

procedure TFormCadVeiculos.quTableBeforeEdit(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Editando registro...';
end;

procedure TFormCadVeiculos.quTableBeforeInsert(DataSet: TDataSet);
begin
