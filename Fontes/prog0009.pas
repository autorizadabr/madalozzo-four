...
procedure TFormCentroCusto.brnExcluirClick(Sender: TObject);
begin
...
procedure TFormCentroCusto.btnFecharClick(Sender: TObject);
begin
  close;
end;

procedure TFormCentroCusto.btnGravarClick(Sender: TObject);
var
  v_status : boolean;
begin
...
procedure TFormCentroCusto.edCodiExit(Sender: TObject);
begin
...
procedure TFormCentroCusto.edCodiPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  edcodi.Text:= consulta('cons_centro');
  edCodiExit(self);
  eddesc.SetFocus;
end;
...
begin
  ...
  lbTitu.Caption               := 'Centros de Custo';
  Caption                      := '..::PROG0009::..';
  v_tabela                     := 'cecu';
  v_esquema                    := 'cadastro';
...
procedure TFormCentroCusto.quTableAfterCancel(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Navegando...';
end;

procedure TFormCentroCusto.quTableAfterPost(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Navegando...';
end;

procedure TFormCentroCusto.quTableBeforeEdit(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Editando registro...';
end;

procedure TFormCentroCusto.quTableBeforeInsert(DataSet: TDataSet);
begin
