...
procedure TFormPadrao.brnExcluirClick(Sender: TObject);
begin
...
procedure TFormPadrao.edCodiExit(Sender: TObject);
begin
...
procedure TFormPadrao.edCodiPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
...
procedure TFormPadrao.quTableAfterCancel(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Navegando...';
end;

procedure TFormPadrao.quTableAfterPost(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Navegando...';
end;

procedure TFormPadrao.quTableBeforeEdit(DataSet: TDataSet);
begin
  sb.Panels[0].text:= 'Enditando registro...';
end;

procedure TFormPadrao.quTableBeforeInsert(DataSet: TDataSet);
begin
